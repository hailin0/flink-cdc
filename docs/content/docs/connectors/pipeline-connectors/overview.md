...
| [DuckLake]({{< ref "docs/connectors/pipeline-connectors/ducklake" >}})           | Sink           | <li> [DuckLake](https://ducklake.select/) with DuckDB 1.5.5.1, PostgreSQL 12+, and S3-compatible storage                                                                                                                                                                                                                                                                                               | [DuckLake](https://mvnrepository.com/artifact/org.apache.flink/flink-cdc-pipeline-connector-ducklake) |
...
|:-----------------:|:-------------------------:|:-------------------------:|:-------------------------------------------------------------------------------------------:|:----------------------------------------:|
|     **3.7.x**     |      1.20.\*, 2.2.\*      | MySQL, PostgreSQL, Oracle | StarRocks, Doris, Paimon, Kafka, Elasticsearch, OceanBase, MaxCompute, Iceberg, Fluss, Hudi, DuckLake |                                          |
