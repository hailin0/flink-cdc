...
/** JDBC implementation of the atomic DuckLake data, schema, and checkpoint transaction. */
@Internal
public final class DuckLakeJdbcCommitExecutor implements DuckLakeCommitExecutor {
    ...
    private DuckLakeSchemaChangeExecutor schemaChangeExecutor;
    ...
    public void beginCheckpoint(String sinkId, String operatorId, List<TableId> tables)
        ...
        schemaChangeExecutor().clearCache();
        client.begin();
        try {
    ...
    public void applySchemaChange(DuckLakeSchemaChangeResult schemaChangeResult)
            throws SQLException {
        schemaChangeExecutor().apply(schemaChangeResult.getEvent());
    ...
    private DuckLakeSchemaChangeExecutor schemaChangeExecutor() {
        if (schemaChangeExecutor == null) {
            schemaChangeExecutor = new DuckLakeSchemaChangeExecutor(client);
        }
